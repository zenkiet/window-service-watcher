    ...
    >
      {#if status === 'idle'}
        <div class="flex shrink-0 items-center justify-between border-b border-white/5 px-5 py-4">
          ...
          >
            <i class="size-4 icon-[regular--x]"></i>
          </button>
        </div>
        ...
        <div class="scrollable flex max-h-[60vh] flex-col overflow-y-auto p-5">
          ...
          >
            <div class="pointer-events-none flex flex-col items-center">
              <i
                class={`transition-colors icon-[regular--cloud-arrow-up] ${files.length > 0 ? 'mb-2 size-6' : 'mb-3 size-8'} ${isDragging ? 'text-blue-400' : 'text-white/20'}`}
              ></i>
        ...
        >
          ...
          >
            <i class="icon-[regular--download]"></i> Install
          </button>
        </div>
      {:else}
        <div
